      ...
      <div className='w-full flex flex-col lg:flex-row items-center lg:items-stretch gap-6 rounded-lg p-3 sm:p-6 bg-white shadow'>
        ...
        <div className='flex-1 flex flex-col justify-between'>
          <div className='relative'>
            ...
            <h1 className='text-[18px] sm:text-[25px] md:text-[25px] font-bold mt-2 text-black'> <span className='font-bold text-blue-500'>Kitob nomi: </span> {product.title}</h1>
            <h2 className='absolute top-[-20px] right-[1px] md:text-[20px] text-[17px] font-bold mt-2 text-blue-500'>{product.price} so'm</h2>
            <h2 className='text-[15px] mt-2 text-black-500'> <span className='font-bold text-blue-500'>Kitoblar soni:</span>  {product.numberOfbooks} ta</h2>
